                 ...
                 <form action="" method="post" enctype="multipart/form-data">
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="<?php echo $postresult['image']; ?>" alt="Post Image" height="80px" width="200px"><br/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="description" value="<?php echo $postresult['meta_description']; ?>" class="medium" />
                            </td>
                        </tr>
						<tr>
                            <td></td>
